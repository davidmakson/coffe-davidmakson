<template>
<div id="app">
    <div class="menus-area section-padding" id="menu">
...
.area-title h2::after {
    background: rgba(0, 0, 0, 0) url("http://quomodosoft.com/html/dawat/demo/img/icons/red.png") no-repeat scroll center center / contain;
    bottom: 0;
    content: "";
    height: 30px;
    left: 0;
...
.mainmenu-area::after {
    background: rgba(0, 0, 0, 0) url("http://quomodosoft.com/html/dawat/demo/img/icons/tri-promo-bottom-white.png") repeat scroll 0 0;
    bottom: -7px;
    content: "";
    height: 7px;
    left: 0;
...
.pogoSlider-slide::after {
    background: #000 url("http://quomodosoft.com/html/dawat/demo/img/pattarn.png") repeat scroll 0 0;
    content: "";
    height: 100%;
    left: 0;
    opacity: 0.6;
...
.about-area {
    background: rgba(0, 0, 0, 0) url("http://quomodosoft.com/html/dawat/demo/img/about/home_three_about_bg.png") no-repeat scroll center bottom / contain;
    position: relative;
}
...
.blog-area-bg,
.footer-area-bg {
    background: rgba(0, 0, 0, 0) url("http://quomodosoft.com/html/dawat/demo/img/promotions/promotions_area_bg_1.jpg") no-repeat scroll center center / cover;
    height: 100%;
    left: 0;
    position: absolute;
    top: 0;
...
.page-barner-bg::after {
    background: #000 url("http://quomodosoft.com/html/dawat/demo/img/pattarn.png");
    content: "";
    height: 100%;
    left: 0;
    opacity: 0.8;
...
.reservation-button-area-bg {
    background: rgba(0, 0, 0, 0) url("http://quomodosoft.com/html/dawat/demo/img/promotions/promotions_area_bg_2.jpg") no-repeat scroll center center / cover;
}
...
.blog-area-bg {
    background: rgba(0, 0, 0, 0) url("http://quomodosoft.com/html/dawat/demo/img/promotions/promotions_area_bg_3.jpg") no-repeat scroll center center / cover;
}
...
.footer-area-bg {
    background: rgba(0, 0, 0, 0) url("http://quomodosoft.com/html/dawat/demo/img/footer_bg_2.jpg") no-repeat scroll center center / cover;
}
...
.top-area-bg {
    background: rgba(0, 0, 0, 0) url("http://quomodosoft.com/html/dawat/demo/img/slider/slide_1.jpg") no-repeat scroll center center / cover;
    height: 100%;
    left: 0;
    position: absolute;
    top: 0;
...
.top-area-bg::before {
    background: #000000 url("http://quomodosoft.com/html/dawat/demo/img/pattarn.png") repeat scroll 0 0;
    content: "";
    height: 100%;
    left: 0;
    opacity: 0.5;
